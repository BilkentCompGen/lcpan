...
### LCP levels analyses based on overlapping rgfa graph

echo "Experiment on different LCP levels started (ov-rgfa)..."

mkdir lcpan-levels-ov-rgfa
cd lcpan-levels-ov-rgfa
...
### LCP levels analyses based on overlapping gfa graph

echo "Experiment on different LCP levels started (ov-gfa)..."

mkdir lcpan-levels-ov-gfa
cd lcpan-levels-ov-gfa
...
/bin/time -v ../lcpan -vgx -r ../hg38.chr22.fa -v ../pggb.chr22.vcf -p hg38.chr22.pggb.lcpan --gfa --verbose > hg38.chr22.pggb.lcpan.out 2>&1;
...
mkdir lcpan.vgx.results
mv lcpan-threads lcpan.vgx.results
mv lcpan-levels-nov-rgfa lcpan.vgx.results
mv lcpan-levels-ov-rgfa lcpan.vgx.results
mv lcpan-levels-nov-gfa lcpan.vgx.results
mv lcpan-levels-ov-gfa lcpan.vgx.results
mv alignment-chr22 lcpan.vgx.results